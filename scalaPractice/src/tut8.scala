...
//  }
//  
//  def toStr1 (t:Term) : String = {
//    t match {
//      case Var(n) => n
//      case Fun(arg,body) => {
//       	 arg ++" " ++ toStr1(body)
//      }
//      case FApp(t1,t2) =>  toStr1(t1) ++ " " ++ toStr1(t2) 
//        
//    }
//  }
//  def toStr2 (t:Term) : String = {
//    t match {
//      case Var(n) => n
//      case Fun(arg,body) => {
//       	"\\" ++ arg ++" . " ++ toStr2(body)
//      }
//      case FApp(t1,t2) => "(" ++ toStr2(t1) ++ " " ++ toStr2(t2) ++ ")"
//        
//    }
//  }
//  def toStr3 (t:Term) : String = {
//    t match {
//      case Var(n) => n
//      case Fun(arg,body) => {
//       	"\\" ++ arg ++" . " ++ toStr3(body)
//      }
//      case FApp(t1,t2) => "(" ++ toStr3(t1) ++ " " ++ toStr3(t2) ++ ")"
//        
//    }
//  }
//  println(toStr(f1))
