...
public class LogisticRegression {
    ...
    private int maxInterations= 4000;
    private double thresholdDelta = 0.002 ;
    ...
    public void train(List<List<Integer>> InputData, Vector<String> FeatureList){
    	try{
	        ...
	        BufferedWriter bw1 = new BufferedWriter(new FileWriter("/Users/yumengyin/Desktop/testingdata/errorrate"));
...
//	                System.out.println("the label is "+label+"the predicted is "+predicted);
				...
				bw1.write(n+"\t"+Double.toString(Math.sqrt(sumDelta))+"\n");
				}
